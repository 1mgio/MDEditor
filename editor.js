 ...
 *
 *  @package    MDEditor
 *  @author     Damien Wright / 1mg Studio
 *  @copyright  2015 Damien Wright / 1mg Studio
 *  @version    1.0.0
 *
 */
...
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
// NOTE: This has been modified from the original version to remove linking
//       GitHub-only references, like references to issues using #X.

(function(mod) {
    if (typeof exports == "object" && typeof module == "object") // CommonJS
        mod(require("./codemirror"), require("./markdown"), require("./overlay"));
    else if (typeof define == "function" && define.amd) // AMD
        define(["./codemirror", "./markdown", "./overlay"], mod);
    else // Plain browser env
        mod(CodeMirror);
})(function(CodeMirror) {
    "use strict";
...
var toolbar = [{
    ...
    {
        name: "guide",
        action: "https://github.com/1mgio/MDEditor/guide",
...
Editor.prototype.render = function(el) {
    ...
    this.codemirror = CodeMirror.fromTextArea(el, {
        ...
        indentUnit: (options.indentUnit !== undefined) ? options.indentUnit : 2,
        indentWithTabs: (options.indentWithTabs === false) ? false : true,
        lineNumbers: (options.lineNumbers === false) ? false : true,
        autoCloseTags: (options.autoCloseTags === false) ? false : true,
        styleActiveLine: (options.styleActiveLine === false) ? false : true,
...
Editor.prototype.autosave = function() {
    ...
    if(this.options.autosave.unique_id === undefined || this.options.autosave.unique_id === ""){
        console.log("Editor: You must set a unique_id to use the autosave feature");
        return;
    }
